    ...
    return (
        <div>
            ...
            <div className='grid grid-cols-5 mx-10 gap-5'>
                <div className='text-center bg-gray-400 rounded-lg py-10 relative'>
                    <div class="avatar relative">
                        <div class="w-24 -z-1 rounded-full ring ring-warning ring-offset-base-100 ring-offset-2">
                            <img src="https://placeimg.com/192/192/people" />
                        </div>
                    </div>
                    <div className='w-8/12 flex items-center mx-auto bg-red-100 -mt-4 absolute bottom-0 text-sm'><FaStar /><span className='ml-2'>4.8</span></div>
