                                                ...
                                                <div className="flex flex-wrap xl:mt-3">
                                                    <div className="xl:w-full bg-white border-price border xl:ml-5 xl:mr-5 xl:pl-5 xl:pt-5 xl:pb-5 rounded-xl">
                                                        <div className="flex flex-wrap">
                                                            ...
                                                            <div className="xl:w-1/2">
                                                                <div className="float-right flex">
                                                                    <h6 className="text-sm text-cart-item-title xl:font-medium xl:mr-5">${subTotal}</h6>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div className="flex flex-wrap">
                                                            ...
                                                            <div className="xl:w-1/2">
                                                                <div className="float-right flex">
                                                                    <h6 className="text-sm text-cart-item-title xl:font-medium xl:mr-5">${TextTrack}</h6>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div className="flex flex-wrap">
                                                            ...
                                                            <div className="xl:w-1/2">
                                                                <div className="float-right flex">
                                                                    <h6 className="text-sm text-cart-item-title xl:font-medium xl:mr-5">-${coupon}</h6>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
