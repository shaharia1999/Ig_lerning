                    ...
                    <div className="flex flex-wrap">
                        ...
                        <div className="w-2/3 relative">
                            <div className="flex right-0 absolute">
                                <Link to="/"><span
                                    className="text-base font-medium leading-tight text-CourseTitle lg:pl-6 lg:pr-6 lg:pt-2 lg:pb-2 rounded-xl mx-2">Business & Company</span></Link>
                                ...
                                <Link to="/digital-marketing"><span
                                    className="text-base font-medium leading-tight bg-maincolor text-white lg:pl-6 lg:pr-6 lg:pt-2 lg:pb-2 rounded-3xl mx-2 h-11">Digital Marketing</span></Link>
                            </div>
                        </div>
                    </div>
