                    ...
                    <div className="flex flex-wrap">
                        ...
                        <div className="w-2/3 relative">
                            <div className="flex right-0 absolute">
                                <Link to="/"><span className="text-base font-medium leading-tight bg-maincolor text-white lg:pl-6 lg:pr-6 lg:pt-2 lg:pb-2 rounded-3xl mx-2 h-11">Business & Company</span></Link>
                                <Link to="/"><span className="text-base font-medium leading-tight text-CourseTitle lg:pl-6 lg:pr-6 lg:pt-2 lg:pb-2 rounded-xl mx-2">Finance</span></Link>
                                <Link to="/"><span className="text-base font-medium leading-tight text-CourseTitle lg:pl-6 lg:pr-6 lg:pt-2 lg:pb-2 rounded-xl mx-2">IA & Big Data</span></Link>
                                <Link to="/"><span className="text-base font-medium leading-tight text-CourseTitle lg:pl-6 lg:pr-6 lg:pt-2 lg:pb-2 rounded-xl mx-2">Digital Marketing</span></Link>
                            </div>
                        </div>
                    </div>
                            ...
                            <div className="wrapper bg-gray-400 antialiased text-gray-900">
                                ...
                                <div className="relative px-4 -mt-16">
                                    <div className="bg-white p-3 rounded-lg shadow-lg">
                                        <div className="flex flex-wrap">
                                            <div className="w-4/5">
                                                <h4 className="mt-1 text-lg font-semibold text leading-tight text-CourseTitle">Traning English Course Learn Online</h4>
                                            </div>
                                            <div className="w-1/5">
                                        ...
                                        <div className="flex flex-wrap">
                                            ...
                                            <div className="w-1/3">
                                                <div className="flex relative sm:justify-center xl:justify-start">
                                                    <span className="text-maincolor text-lg font-medium inset-y-0 right-0 absolute">$4.99</span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="flex flex-wrap">
                                            ...
                                            <div className="w-1/2 relative">
                                                <div className="flex sm:justify-center xl:justify-start -mt-3 right-0 absolute">
                                ...
                                <div className="relative px-4 -mt-16">
                                    <div className="bg-white p-3 rounded-lg shadow-lg">
                                        ...
                                        <div className="flex flex-wrap">
                                            ...
                                            <div className="w-1/2 relative">
                                                <div className="flex sm:justify-center xl:justify-start -mt-3 right-0 absolute">
                                                    <button className="text-sm font-extralight leading-tight bg-BgLoveIcon text-white lg:pl-2 lg:pr-2 lg:pt-1 lg:pb-1 rounded-md px-1"><img className="px-1 h-3 w-5" src={LoveIcon} /></button>
                                                    <button className="text-sm font-extralight leading-tight bg-maincolor text-white lg:pl-2 lg:pr-2 lg:pt-1 lg:pb-1 rounded-sm px-1">Enroll Now</button>
                                                </div>
                                            </div>
                                        </div>
