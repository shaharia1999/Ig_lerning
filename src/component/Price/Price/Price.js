                                ...
                                <div className="xl:flex xl:flex-wrap g-0">
                                    ...
                                    <div className="xl:w-full xl:rounded-lg flex items-center">
                                        <div className="xl:mt-12 w-full">
                                            ...
                                            <h6 className="text-about-analytics-subTitle text-center xl:font-semibold xl:text-4xl xl:mt-4">Meet our exciting pricing policy</h6>
                                            <h6 className="text-about-analytics-subTitle text-center xl:font-medium xl:text-base xl:mt-4 xl:mb-16">No contracts. No Surprise fees</h6>
