                ...
                <div className="container PriceContact">
                    <div className="flex flex-basis">
                        ...
                        <div className="xl:w-1/2 w-full xl:mt-7 justify-center flex">
                            <div className="xl:p-6 rounded-2xl">
                                <button className="about-contact-btn bg-white xl:pt-2 xl:pb-2 xl:pl-12 xl:pr-12 xl:rounded-md xl:mt-4 xl:ml-8 text-maincolor font-normal xl:text-xl flex"> Contact us</button>
                            </div>
                        </div>
