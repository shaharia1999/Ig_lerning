                ...
                <div className="container xl:pt-16 xl:pb-24 pt-10 pb-16">
                    ...
                    <div className="flex flex-wrap xl:mt-6 xl:pl-20 xl:pr-20 pl-3 pr-3">
                        ...
                        <div className="lg:w-1/2 px-4 xl:mt-0 lg:mt-4 md:mt-12 xl:mb-0 mt-4 mb-4">
                            <div className="bg-student-card-bg dark:bg-dark-color2 rounded-2xl shadow-client border-maincolor shadow-student border-2 2xl:p-16 xl:p-10 lg:px-8 lg:py-12 md:px-10 md:py-16 p-5 h-full w-auto">
                                <img className="rounded-full bg-white dark:bg-dark-color2 2xl:h-28 2xl:w-28 xl:h-24 xl:w-24 lg:h-20 lg:w-20 h-16 w-16 xl:mt-0 xl:mb-8 md:mb-4" src={StudentIcon} alt="" />
                                <p className="text-about-text1 dark:text-white xl:text-3xl md:text-2xl 2xl:font-bold lg:font-semibold text-lg font-semibold">Student</p>
                        ...
                        <div className="lg:w-1/2 px-4 xl:mt-0 lg:mt-4 md:mt-12 xl:mb-0 mt-4 mb-4">
                            <div className="bg-teacher-card dark:bg-dark-color2 rounded-2xl shadow-client border-watch-video shadow-teacher border-2 2xl:p-16 xl:p-10 lg:px-8 lg:py-12 md:px-10 md:py-16 p-5 h-full w-auto">
                                <img className="rounded-full bg-white dark:bg-dark-color2 2xl:h-28 2xl:w-28 xl:h-24 xl:w-24 lg:h-20 lg:w-20 h-16 w-16 xl:mt-0 xl:mb-8 md:mb-4" src={TeacherIcon} alt="" />
                                <p className="text-about-text1 dark:text-white xl:text-3xl md:text-2xl 2xl:font-bold lg:font-semibold text-lg font-semibold">Teacher</p>
