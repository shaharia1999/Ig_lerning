                ...
                <div className="container xl:pt-16 xl:pb-24">
                    ...
                    <div className="flex flex-wrap xl:mt-6 xl:pl-20 xl:pr-20">
                        ...
                        <div className="xl:basis-1/2 px-4">
                            <div className="bg-student-card-bg rounded-2xl shadow-client border-maincolor shadow-student border-2 xl:p-16 h-full w-auto">
                                <img className="rounded-full bg-white h-28 w-28 xl:mt-0 xl:mb-8" src={StudentIcon} alt="" />
                                <p className="text-about-text1 xl:text-3xl xl:font-bold">Student</p>
                                <h5 className=" text-xl xl:font-medium text-about-text1 leading-8 xl:mb-4 xl:mt-3">Read unfiltered, write unfiltered, unbiased, 100% validated reviews.</h5>
                        ...
                        <div className="xl:basis-1/2 px-4">
                            <div className="bg-teacher-card rounded-2xl shadow-client border-watch-video shadow-teacher border-2 xl:p-16 h-full w-auto">
                                <img className="rounded-full bg-white h-28 w-28 xl:mt-0 xl:mb-8" src={TeacherIcon} alt="" />
                                <p className="text-about-text1 xl:text-3xl xl:font-bold">Teacher</p>
                                <h5 className=" text-xl xl:font-medium text-about-text1 leading-8 xl:mb-4 xl:mt-3">Get your software or service in front of millions of monthly buyers.</h5>
                                <p className="text-client-section-des text-md mt-2">Reviews written by actual users -- not “pay-to-play” analysts — that help you avoid the inherent risks of buying business technology.</p>
