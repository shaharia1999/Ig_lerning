                ...
                <div className="container xl:pt-16 xl:pb-24 pt-10 pb-16">
                    ...
                    <div className="flex flex-wrap xl:mt-6 xl:pl-20 xl:pr-20 pl-3 pr-3">
                        ...
                        <div className="lg:w-1/2 px-4 xl:mt-0 lg:mt-4 md:mt-12 xl:mb-0 mt-4 mb-4">
                            <div className="bg-student-card-bg dark:bg-dark-color2 rounded-2xl border-maincolor shadow-maincolor shadow-md border-2 2xl:p-16 xl:p-10 lg:px-8 lg:py-12 md:px-10 md:py-16 sm:px-8 sm:py-10 p-5 h-full w-auto">
                        ...
                        <div className="lg:w-1/2 px-4 xl:mt-0 lg:mt-4 md:mt-12 xl:mb-0 mt-4 mb-4">
                            <div className="bg-teacher-card dark:bg-dark-color2 rounded-2xl border-watch-video shadow-maincolor shadow-md border-2 2xl:p-16 xl:p-10 lg:px-8 lg:py-12 md:px-10 md:py-16 sm:px-8 sm:py-10 p-5 h-full w-auto">
