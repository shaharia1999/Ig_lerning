                    ...
                    <div className="flex flex-wrap xl:mt-6">
                        ...
                        <div className="lg:w-2/5 w-full">
                            <div className="xl:pl-0 xl:pr-0 pl-5 pr-5">
                                <img className="xl:h-full h-96 xl:w-full lg:h-full w-full xl:mt-10 xl:mb-7 xl:rounded-xl rounded-2xl" src={Trainer} alt=""/>
                            </div>
                        </div>

                        <div className="lg:w-3/5 w-full xl:pl-0 xl:pr-0 pl-5 pr-5">
                            <div className="xl:p-12">
                                <p className="text-sectionTitleColor 2xl:text-4xl xl:text-3xl text-xl xl:mb-6 xl:mt-0 mt-4 xl:font-semibold font-semibold dark:text-white">Coach and trainer</p>
                                <p className="text-black 2xl:text-lg xl:text-base text-base text-justify font-normal mt-2 dark:text-gray-300">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.</p>
                                <p className="text-black 2xl:text-lg xl:text-base text-base text-justify font-normal mt-2 dark:text-gray-300">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.</p>
                                ...
                                <div className="flex flex-wrap 2xl:mt-10 xl:mt-8 mt-4">
                                    ...
                                    <div className="xl:w-11/12 w-10/12">
                                        <span><p className="text-black text-justify 2xl:text-base xl:text-sm text-sm font-normal dark:text-gray-300">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis.</p></span>
                                    </div>
                                </div>
                                ...
                                <div className="flex flex-wrap 2xl:mt-10 xl:mt-8 mt-4">
                                    ...
                                    <div className="xl:w-11/12 w-10/12">
                                        <span className=""><p className="text-black text-justify 2xl:text-base xl:text-sm text-sm font-normal dark:text-gray-300">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis.</p></span>
                                    </div>
                                </div>
