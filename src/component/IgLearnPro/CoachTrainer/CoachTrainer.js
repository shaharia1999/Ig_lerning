        ...
        return (
            <Fragment>
                <div className="container lg:mt-8 lg:mb-12">
                    <h4 className="text-6xl	font-semibold text-sectionTitleColor dark:text-white text-center lg:mt-20 lg:mb-16">Are you a  Coach or Trainer ?</h4>
                    <div className="flex flex-wrap lg:mt-6">
                        ...
                        <div className="lg:w-3/5 w-full">
                            <div className="lg:p-12">
                                <p className="text-sectionTitleColor lg:text-4xl lg:mb-6 lg:font-semibold dark:text-white">Coach and trainer</p>
                                <p className="text-black text-lg font-normal mt-2 dark:text-gray-300">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.</p>
                                <p className="text-black text-lg font-normal mt-2 dark:text-gray-300">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.</p>
                                ...
                                <div className="flex flex-wrap lg:mt-10">
                                    ...
                                    <div className="lg:w-11/12">
                                        <span><p className="text-black text-md font-normal dark:text-gray-300">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis.</p></span>
                                    </div>
                                </div>
