...
function BestSchoolAndInstitute() {
            ...
            <div className="container 2xl:my-16 xl:my-12 lg:my-8 my-12 2xl:px-16 xl:px-12 lg:px-16 md:px-8 sm:px-8">
                <div className="flex flex-wrap">
                    <div className="2xl:w-1/3 xl:w-1/3 lg:w-1/3 w-full">
                        <div className="flex">
                            <h4 className="2xl:text-3xl xl:text-2xl lg:text-xl text-xl font-semibold text-sectionTitleColor dark:text-white 2xl:ml-6 xl:ml-4 lg:ml-3 ml-4 -mt-6">Best Schools and Institutes on IntelloGeek</h4>
                        </div>
                    </div>
...
// }
export default BestSchoolAndInstitute;