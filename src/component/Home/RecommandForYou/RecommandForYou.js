...
function RecommandForYou() {
    ...
    if (isLoading === true) {
        return (
            <Fragment>
                <div className="container my-12 xl:mt-0 -mt-12">
                    <h4 className="xl:text-4xl text-xl	font-semibold text-sectionTitleColor dark:text-white ml-3">Recommand For You ({BasedTotal}) </h4>
        ...
        return (
            <Fragment>
                <div className="container my-12 xl:mt-0 ">
                    <h4 className="xl:text-4xl text-xl	font-semibold text-sectionTitleColor dark:text-white xl:ml-3 ml-6">Recommand For You ({BasedTotal}) </h4>
