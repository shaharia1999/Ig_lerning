                    ...
                    <div className="container xl:pl-32 xl:pr-32 xl:pt-10">
                        <div className="flex justify-center items-center flex-wrap text-gray-800">
                            <div className="xl:w-10/12">
                                <div className="block bg-white dark:bg-dark-color2 xl:rounded-lg shadow-lg">
                                    <div className="xl:flex xl:flex-wrap g-0">
    
                                        <div className="xl:w-6/12 xl:rounded-lg bg-gray-100 dark:bg-dark-color3 flex items-center">
                                                ...
                                                <div className="tab-content" id="pills-tabContent3">
                                                    <div className="tab-pane fade show active xl:mt-20" id="pills-home3" role="tabpanel" aria-labelledby="pills-home-tab3">
                                                        ...
                                                        <div className="flex flex-wrap xl:mt-4">
                                                            <div className="xl:w-full bg-white dark:bg-dark-color2 hover:bg-price border-price border xl:ml-6 xl:mr-6 xl:pl-5 xl:pt-5 xl:pb-5 rounded-xl">
                                                                <h6 className="text-2xl text-maingray xl:font-medium dark:text-white">Free</h6>
                                                                <h6 className="xl:text-xs  text-maingray font-normal xl:mt-1 dark:text-gray-400">Not ready to commit? Try us out with ease.</h6>
                                                                <h6 className="xl:text-base text-maingray xl:font-normal xl:mt-3 dark:text-gray-500"><span className="text-pagination xl:text-3xl xl:font-medium dark:text-white">$0</span> /month</h6>
                                                            </div>
                                                        </div>
    
                                                        <div className="flex flex-wrap xl:mt-4">
                                                            <div className="xl:w-full bg-white dark:bg-dark-color2 border-price border xl:ml-6 xl:mr-6 xl:pl-5 xl:pt-5 xl:pb-5 rounded-xl">
                                                                <h6 className="text-2xl text-maingray xl:font-medium dark:text-white">Basic</h6>
                                                                <h6 className="xl:text-xs text-maingray font-normal xl:mt-1 dark:text-gray-400">Not ready to commit? Try us out with ease.</h6>
                                                                <h6 className="xl:text-base text-maingray xl:font-normal xl:mt-3 dark:text-gray-500"><span className="text-pagination xl:text-3xl xl:font-medium dark:text-white">$29</span> /month</h6>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div className="flex flex-wrap xl:mt-4">
                                                            <div className="xl:w-full bg-white dark:bg-dark-color2 border-price border xl:ml-6 xl:mr-6 xl:pl-5 xl:pt-5 xl:pb-5 rounded-xl">
                                                                <h6 className="text-2xl text-maingray xl:font-medium dark:text-white">Pro</h6>
                                                                <h6 className="xl:text-xs text-maingray font-normal xl:mt-1 dark:text-gray-400">Not ready to commit? Try us out with ease.</h6>
                                                                <h6 className="xl:text-base text-maingray xl:font-normal xl:mt-3 dark:text-gray-500"><span className="text-pagination xl:text-3xl xl:font-medium dark:text-white">$99</span> /month</h6>
                                                            </div>
                                                        </div>
    
                                                        <div className="flex flex-wrap xl:mt-4 xl:mb-6">
                                                            <div className="xl:w-full bg-white dark:bg-dark-color2 border-price border xl:ml-6 xl:mr-6 xl:pl-5 xl:pt-5 xl:pb-5 rounded-xl">
                                                                <h6 className="text-2xl text-maingray xl:font-medium dark:text-white">Business</h6>
                                                                <h6 className="xl:text-xs text-maingray font-normal xl:mt-1 dark:text-gray-400">Not ready to commit? Try us out with ease.</h6>
                                                                <h6 className="xl:text-base text-maingray xl:font-normal xl:mt-3 dark:text-gray-500"><span className="text-pagination xl:text-3xl xl:font-medium dark:text-white">$249</span> /month</h6>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div className="lg:w-6/12 px-4 md:px-0">
                                            <div className="md:p-8 md:mx-6">
                                                <div className=" justify-start">
                                                    <h4 className="text-2xl text-maingray dark:text-white xl:font-medium lg:mt-5">Payment Details</h4>
                                                    <h6 className="text-xs text-maingray dark:text-gray-400 xl:font-light">Complete your purchase by providing payment details</h6>
                                                </div>
    
    
                                                <div className="flex flex-wrap xl:mt-4">
                                                    <div className="w-full flex">
                                                        <div className="xl:w-2/12 bg-white border-gray-200 hover:border-price xl:border-2 justify-center flex rounded-md xl:m-1">
                                                ...
                                                <form className="lg:mt-4">
                                                    <div className="flex justify-center">
                                                        <div className="mb-3 xl:w-full">
                                                            <label for="exampleFormControlInput1" className="form-label text-sm inline-block mb-2 text-maingray dark:text-gray-400">Email Address <sup>*</sup></label>
                                                            <input
                                                                type="text"
                                                                className="form-control rounded block w-full px-3 py-2.5 text-sm font-normal text-maingray dark:text-white bg-white dark:bg-dark-color3 bg-clip-padding border border-solid border-gray-300 dark:border-gray-500 transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                                                    ...
                                                    <div className="flex justify-center">
                                                        <div className="mb-3 xl:w-full">
                                                            <label for="exampleFormControlInput1" className="form-label text-sm inline-block mb-2 text-maingray dark:text-gray-400">Cardholder Name <sup>*</sup></label>
                                                            <input
                                                                type="text"
                                                                className="form-control rounded block w-full px-3 py-2.5 text-sm font-normal text-maingray dark:text-white bg-white dark:bg-dark-color3 bg-clip-padding border border-solid border-gray-300 dark:border-gray-500 transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                                                                id="exampleFormControlInput1"
                                                    ...
                                                    <div className="flex justify-center">
                                                        <div className="mb-3 xl:w-full">
                                                            <label for="exampleFormControlInput1" className="form-label text-sm inline-block mb-2 text-maingray dark:text-gray-400">Card Details <sup>*</sup></label>
                                                            <input
                                                                type="text"
                                                                className="form-control rounded block w-full px-3 py-2.5 text-sm font-normal text-maingray dark:text-white bg-white dark:bg-dark-color3 bg-clip-padding border border-solid border-gray-300 dark:border-gray-500 transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                                                                id="exampleFormControlInput1"
                                                    ...
                                                    <div className="flex">
                                                        <div className="mb-3 xl:w-1/2 xl:mr-4">
                                                            <label for="exampleFormControlInput1" className="form-label text-sm inline-block mb-2 text-maingray dark:text-gray-400">Expiry <sup>*</sup></label>
                                                            <input
                                                                type="text"
                                                                className="form-control rounded block w-full px-3 py-2.5 text-sm font-normal text-maingray dark:text-white bg-white dark:bg-dark-color3 bg-clip-padding border border-solid border-gray-300 dark:border-gray-500 transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                                                                id="exampleFormControlInput1"
                                                        ...
                                                        <div className="mb-3 xl:w-1/2 xl:ml-4">
                                                            <label for="exampleFormControlInput1" className="form-label text-sm inline-block mb-2 text-maingray dark:text-gray-400">CVC <sup>*</sup></label>
                                                            <input
                                                                type="text"
                                                                className="form-control rounded block w-full px-3 py-2.5 text-sm font-normal text-maingray dark:text-white bg-white dark:bg-dark-color3 bg-clip-padding border border-solid border-gray-300 dark:border-gray-500 transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                                                                id="exampleFormControlInput1"
                                                    ...
                                                    <div className="flex flex-wrap">
                                                        ...
                                                        <div className="mb-3 xl:w-1/2 xl:-mt-1">
                                                            <input
                                                                type="text"
                                                                className="form-control rounded-l block w-full px-3 py-2.5 text-sm font-normal text-maingray dark:text-white bg-white dark:bg-dark-color3 bg-clip-padding border border-solid border-gray-300 dark:border-gray-500 transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                                                                id="exampleFormControlInput1"
                                                                placeholder="Zip"
                                                            />
                                                        </div>
                                                        ...
                                                        <div className="mb-3 xl:w-1/2 xl:-mt-1">
                                                            <input
                                                                type="text"
                                                                className="form-control rounded-r block w-full px-3 py-2.5 text-sm font-normal text-maingray dark:text-white bg-white dark:bg-dark-color3 bg-clip-padding border border-solid border-gray-300 dark:border-gray-500 transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                                                                id="exampleFormControlInput1"
                                                                placeholder="State"
                                                            />
                                                        </div>
                                                    ...
                                                    <div className="flex flex-wrap">
                                                        <label for="exampleFormControlInput1" className="form-label text-sm inline-block mb-2 text-maingray dark:text-gray-400">Apply Cupon</label>
