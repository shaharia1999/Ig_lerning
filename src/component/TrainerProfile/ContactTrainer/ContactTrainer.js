                ...
                <form className="">
                    <div className="flex flex-basis mb-6">
                        <div className="xl:w-6/12 px-3 mb-6 xl:mb-0">
                            <input 
                                className="bg-white w-full xl:font-normal text-breadcrumbs-text text-sm border border-none rounded-sm py-4 xl:px-4 mb-3 leading-tight focus:outline-none"
                                type="text"
                                value={name}
                    ...
                    <div className="flex flex-wrap mb-6">
                        <div className="px-3 xl:w-full">
                            <textarea 
                                className=" no-resize appearance-none block w-full xl:font-normal bg-white text-breadcrumbs-text text-sm border-none rounded-sm py-3 px-4 mb-3 leading-tight focus:outline-none h-48 resize-none"
                                placeholder="Message"
                                value={message}
