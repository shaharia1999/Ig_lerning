                                        ...
                                        <div className="w-1/2">
                                            <div className="space-y-6 xl:pr-3">
                                                <div className="grid grid-cols-2 gap-3">
                                                    <div className="h-6 bg-white rounded xl:mt-3 col-span-1"></div>
                                                    <div className="h-6 bg-gray-100 rounded xl:mt-3 col-span-1"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            return (
                upCommingEvent.map((up_comming_event, up_comming_event_index) => (
                    <div key={up_comming_event_index} className="flex xl:mb-5">
                        <div className="flex w-full rounded-lg bg-white shadow-upcomming">
                            <div className="xl:w-1/3 relative">
                            ...
                            <div className="xl:w-2/3 xl:pl-3">
                                <div className=" flex flex-col justify-start">
                                    <h5 className="text-maingray text-base xl:font-semibold xl:mt-2">{up_comming_event.course_seminar_title}</h5>
                                    <h5 className="text-maincolor text-base xl:font-semibold">{up_comming_event.location}</h5>
                                    <h5 className="text-upcomming-green text-xs xl:font-semibold xl:mb-1">Hall gare du nord</h5>
                                    <div className="flex">
                                        <div className="w-1/2">
                                            <h5 className="text-gray-500 flex text-xs"><FaUsers className="mr-2 text-gray-500 text-base" />{up_comming_event.participant}</h5>
                                        </div>
                                        <div className="w-1/2">
