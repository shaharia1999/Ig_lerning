...
function UpCommingEvents() {
    ...
    const UpCommingHTML = (() => {
        if (isLoading === true) {
                ...
                <div class="flex w-full rounded-lg bg-white shadow-upcomming">
                    ...
                    <div className="xl:w-2/3 xl:pl-3">
                        <div class=" flex flex-col justify-start">
                            <h5 class="text-maingray text-base xl:font-semibold xl:mt-2">Unleash your potential in 3 Days</h5>
                            <h5 class="text-maincolor text-base xl:font-semibold">Paris</h5>
                            <h5 class="text-upcomming-green text-xs xl:font-semibold xl:mb-1">Hall gare du nord</h5>
                            <div className="flex">
                                <div className="w-1/2">
                                    <h5 class="text-gray-500 flex text-xs"><FaUsers className="mr-2 text-gray-500 text-base" />1703</h5>
                                </div>
                                <div className="w-1/2">
            ...
            return upCommingEvent.map((up_comming_event, up_comming_event_index) => (
