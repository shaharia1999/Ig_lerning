                                        ...
                                        <div className="md:p-8 md:mx-6">
                                            ...
                                            <form className="lg:mt-4">
                                                ...
                                                <div className="flex flex-wrap">
                                                    ...
                                                    <div className="xl:w-1/2">
                                                        <div className="float-right flex">
                                                            <button className="text-maincolor border border-maincolor rounded-2xl text-xs xl:pt-1 xl:pb-1 xl:pl-2 xl:pr-2">+ Add New</button>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div className="flex flex-wrap">
                                                    <div className="px-1 bg-white xl:pt-2 xl:pb-2 rounded-md border-2 border-gray-300 hover:border-price xl:my-2.5 xl:px-1.5 w-full">
                                                        <div className="wrapper flex antialiased">
                                                            <div className="relative w-2/12">
                                                                <div className="form-group form-check xl:mt-2.5 xl:ml-3">
                                                                    <input type="checkbox"
                                                                        className="ring-10 h-6 w-6 rounded-full text-price bg-gray-100 border-gray-300 focus:ring-price" checked/>
                                                                </div>
                                                            </div>

                                                            <div className="xl:w-2/12 border-gray-200 xl:border-2 justify-center flex rounded-md xl:m-1">
                                                                <img className="xl:pt-0.5 xl:pb-1 xl:pl-2 xl:pr-2 xl:h-7 xl:mt-1" src={MasterCard} alt="" />
                                                            </div>
                                                            ...
                                                            <div className="w-6/12">
                                                                <div className="flex flex-wrap">
                                                                    <div className="w-full">
                                                                        ...
                                                                        <h4 className="xl:mt-0.5 xl:ml-2 xl:text-sm xl:font-medium leading-tight text-cart-item-title">
                                                                            **** **** **** 3279
                                                                        </h4>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div className="w-2/12 xl:pr-2">
                                                                <div className="flex flex-wrap">
                                                                    <div className="w-full">
                                                                        <div className="flex xl:justify-end">
                                                                            <span className="text-maingray xl:text-lg xl:mr-2 xl:font-medium">Exp</span>
                                                                        </div>
                                                                    </div>
                                                                </div>

                                                                <div className="flex w-full flex-wrap xl:mt-0 xl:justify-end">
                                                                   <h6 className="text-gray-500 xl:text-xs xl:mr-3 xl:font-semibold">**/24</h6>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div className="px-1 bg-white xl:pt-2 xl:pb-2 rounded-md border-2 border-gray-300 hover:border-price xl:my-2.5 xl:px-1.5 w-full">
                                                        <div className="wrapper flex antialiased">
                                                            ...
                                                            <div className="xl:w-2/12 border-gray-200 xl:border-2 justify-center flex rounded-md xl:m-1">
                                                                <img className="xl:pt-0.5 xl:pb-1 xl:pl-2 xl:pr-2 xl:h-7 xl:mt-1" src={Visa} alt="" />
                                                            </div>
                                                ...
                                                <hr className="xl:mt-4 xl:mb-5 border"/>
